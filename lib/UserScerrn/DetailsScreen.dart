...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  Future<SinglePageDetails> getSinglePlace() async {
    ...
    openHours = singlePageDetails.result?.currentOpeningHours?.periods?[0].close
        ?.time ?? "";
  ...
  String time24to12Format(String? time) {
    ...
    int h = int.parse(timerStr
        .split(".")
        .first);
    int m = int.parse(timerStr
        .split(".")
        .last
        .split(" ")
        .first);
...
//    IconData? _selectedIcon;
                  ...
                  return <Widget>[
                    SliverAppBar(
                      ...
                      flexibleSpace: FlexibleSpaceBar(
                        ...
                        background: singlePageDetails.result?.photos?[0]
                            .photoReference == null
                            ? Image.asset(
                            Img.get('resort_restarunts.jpg'), fit: BoxFit.cover)
                            : getImage(
                            "${singlePageDetails.result?.photos?[0]
                                .photoReference}",
                                        ...
                                        Container(
                                          child: Container(
                                            ...
                                            child: RatingBarIndicator(
                                              rating: singlePageDetails.result
                                                  ?.rating == null
                                                  ? 0.0
                                                  : singlePageDetails.result
                                                  ?.rating.toDouble(),
                                                  ...
                                                  onTap: () async {
                                                    ...
                                                    Navigator.push(context, MaterialPageRoute(builder: (context) =>
                                                                VideoReviewDetailsScreen(
                                                                    filePath: videoreviewDet[index].video!,
                                                                    videorating: videoreviewDet[index].rating!,
                                                                    videoDate: videoreviewDet[index].reviewDate!,
                                                                    videoName: videoreviewDet[index].reviewerName!)));
                                                  },
                                                  child: Container(
                                                    width: 140,
                                                              ...
                                                              Flexible(
                                                                ...
                                                                child: Container(
                                                                  ...
                                                                  BoxDecoration(
                                                                    image: DecorationImage(
                                                                      image: NetworkImage(
                                                                          "https://www.2designnerds.com/wherenx_user/public/images/${reviewDet[index]
                                                                              .profilePhoto}"),
                                                                      fit: BoxFit
                                                                          .cover,
                                                                    ),
  ...
  String getImage1(String photoReference) {
    ...
    var maxHeight = "110";
    final url =
        "$baseurl?maxwidth=$maxWidth&maxheight=$maxHeight&photo_reference=$photoReference&key=$googleApikey";
    return url;
  }
  ...
  Future<void> onButtonTap(Share share, String strData,
      String strPhotourl) async {
    String msg = strData;
